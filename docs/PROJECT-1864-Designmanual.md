...
- **v00.02.08** — P0A v00.00.08: våbenprofilen styrer nu basis-reload, regimentets experience modificerer reload-tiden inden for et begrænset interval, og positive salver viser kort combat feedback som `Ramte N` over målet. Salver kan nu også give 0 direkte hits, mens shock fortsat kan påvirke målet. P0A v00.00.07 er observeret fungerende i Play Mode med korrekt runtime-bootstrap/rendering; v00.00.08 afventer ny Unity compile/Play-validering.
