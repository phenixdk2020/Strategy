...
// v00.00.09c TEST: lightweight regimental colours/standards for Battle mode.
...
public sealed class PrototypeRegimentalStandards : MonoBehaviour
{
    ...
    private static void AutoCreate()
    {
        ...
        GameObject root = new GameObject("PrototypeRegimentalStandards_v000009c");
    ...
    private static GameObject CreateStandard(Regiment regiment)
    {
        ...
        // Final regimental colours will be replaced by historically sourced art/data.
        if (regiment.Team == BattleTeam.Denmark)
        {
