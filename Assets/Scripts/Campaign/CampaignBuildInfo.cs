public static class CampaignBuildInfo
{
    ...
    public const string CurrentVersion = "v00.00.10n6e";
    public const string CurrentBuildName = "CAMPAIGN3 HISTORICAL COUNTY SEEDS + CITY ART VISIBILITY 10N6E";
    public const string BranchTarget = "channel-campaign3";
    public const string LogTag = "CAMPAIGN-10N6E";
}
