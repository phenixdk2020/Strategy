public static class CampaignBuildInfo
{
    ...
    public const string CurrentVersion = "v00.00.10n7g";
    public const string CurrentBuildName = "CAMPAIGN3 COASTAL CITY OFFSET PASS 2 10N7G";
    public const string BranchTarget = "channel-campaign3";
    public const string LogTag = "CAMPAIGN-10N7G";
