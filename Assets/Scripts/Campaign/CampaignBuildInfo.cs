public static class CampaignBuildInfo
{
    ...
    public const string CurrentVersion = "v00.00.10n3";
    public const string CurrentBuildName = "CAMPAIGN3 ZONE LINE POLISH + COMPACT INFO 10N3";
    public const string BranchTarget = "channel-campaign3";
    public const string LogTag = "CAMPAIGN-10N3";
}
