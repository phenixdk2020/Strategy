public static class CampaignBuildInfo
{
    ...
    public const string CurrentVersion = "v00.00.10n6d";
    public const string CurrentBuildName = "CAMPAIGN3 EMBEDDED ZONE RESOLVER COMPILE HOTFIX 10N6D";
    public const string BranchTarget = "channel-campaign3";
    public const string LogTag = "CAMPAIGN-10N6D";
}
