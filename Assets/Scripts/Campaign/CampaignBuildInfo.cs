public static class CampaignBuildInfo
{
    ...
    public const string CurrentVersion = "v00.00.10n6";
    public const string CurrentBuildName = "CAMPAIGN3 ISOMETRIC CITY ICONS 10N6";
    public const string BranchTarget = "channel-campaign3";
    public const string LogTag = "CAMPAIGN-10N6";
}
