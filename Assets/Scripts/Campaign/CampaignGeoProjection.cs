...
/// <summary>
/// Shared geospatial contract for PROJECT 1864 campaign generations.
/// WGS84 longitude/latitude remains authoritative. Unity coordinates are render-only.
/// This compatibility surface keeps the Denmark-first v00.00.10e projection API
/// while adding the broad strategic-map API used by v00.00.11+.
/// </summary>
public static class CampaignGeoProjection
{
    // v00.00.10e Denmark-first local projection API.
    ...
    // v00.00.11+ broad strategic render envelope.
    ...
    // Legacy Denmark-first call order: longitude, latitude.
    ...
    // v00.00.11+ broad-map call order: latitude, longitude.
