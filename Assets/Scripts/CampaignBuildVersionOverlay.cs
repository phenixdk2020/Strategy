...
{
    public const string CampaignVersion = "v00.00.13l";
    public const string CampaignChannel = "PREMIUM CARTOGRAPHIC VISUAL DEV";
    ...
    private static void AutoCreate()
    {
        ...
        GameObject root = new GameObject("CampaignBuildVersionOverlay_v0013l");
