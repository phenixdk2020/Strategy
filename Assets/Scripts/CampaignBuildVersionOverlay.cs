...
{
    public const string CampaignVersion = "v00.00.13m1";
    public const string CampaignChannel = "UNIFIED MAP STARTUP ISOLATION DEV";
    ...
    private static void AutoCreate()
    {
        ...
        GameObject root = new GameObject("CampaignBuildVersionOverlay_v0013m1");
