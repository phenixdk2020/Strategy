...
{
    public const string CampaignVersion = "v00.00.11";
    public const string CampaignChannel = "WORK";
    ...
    private static void AutoCreate()
    {
        ...
        GameObject root = new GameObject("CampaignBuildVersionOverlay_v0011");
