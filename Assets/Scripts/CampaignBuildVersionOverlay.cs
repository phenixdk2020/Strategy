...
{
    public const string CampaignVersion = "v00.00.13c";
    public const string CampaignChannel = "DENMARK CLEANUP DEV";
    ...
    private static void AutoCreate()
    {
        ...
        GameObject root = new GameObject("CampaignBuildVersionOverlay_v0013c");
