...
{
    public const string CampaignVersion = "v00.00.13b";
    public const string CampaignChannel = "VISUAL POLISH DEV";
    ...
    private static void AutoCreate()
    {
        ...
        GameObject root = new GameObject("CampaignBuildVersionOverlay_v0013b");
