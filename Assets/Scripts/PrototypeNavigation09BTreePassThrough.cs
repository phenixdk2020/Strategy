...
// v00.00.09f1 soft-obstacle compatibility layer.
...
public sealed class PrototypeNavigation09BTreePassThrough : MonoBehaviour
{
    ...
    private static void AutoCreate()
    {
        ...
        GameObject root = new GameObject("PrototypeNavigationSoftPassThrough_v000009f1");
    ...
    private void Update()
    {
        ...
        Debug.Log(string.Format(
            "NAV-SOFT-09F1|Build=v00.00.09f1|Trees=PassThrough|FencePosts=PassThrough|RemovedTrees={0}|RemovedFencePosts={1}|V3StatesReset=True|BuildingsBlocked=True|RiverBlocked=True",
            removedTrees,
            removedFencePosts));
    }
